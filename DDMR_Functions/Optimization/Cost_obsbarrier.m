...
%% DISCUSSION BETWEEN 2 CANDIDATES OF BARRIER FUNCTION AS FOLLOWS:
...
%% 2) Const * exp( -a* c(x)>=0 )
    ...
    %  tune2 * exp(-tune3 * d/(tune1)) will give us huge penalisation if d goes to zero
...
% Important Variables in the code
    % d: Safety Distance established by follows :
